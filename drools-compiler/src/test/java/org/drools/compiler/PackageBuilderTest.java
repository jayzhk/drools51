...
public class PackageBuilderTest extends DroolsTestCase {
    ...
    public void testReload() throws Exception {
        ...
        DefaultKnowledgeHelper knowledgeHelper = new DefaultKnowledgeHelper( workingMemory );
    ...
    public void testSerializable() throws Exception {
        ...
        final DefaultKnowledgeHelper knowledgeHelper = new DefaultKnowledgeHelper( workingMemory );
        knowledgeHelper.setActivation( activation );
