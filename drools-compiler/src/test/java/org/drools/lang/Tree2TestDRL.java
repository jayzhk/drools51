...
public class Tree2TestDRL extends TreeParser {
    ...
    public static final BitSet FOLLOW_package_statement_in_compilation_unit45 = new BitSet(new long[]{0xAB9FE00000000028L,0x000000000000000FL,0x0000000000000001L});
    public static final BitSet FOLLOW_statement_in_compilation_unit48 = new BitSet(new long[]{0xAB9FE00000000028L,0x000000000000000FL,0x0000000000000001L});
    ...
    public static final BitSet FOLLOW_lhs_block_in_query245 = new BitSet(new long[]{0x0000000000000000L,0x0000000000010000L});
    ...
    public static final BitSet FOLLOW_data_type_in_param_definition275 = new BitSet(new long[]{0x0000004000000008L,0x0000000000080000L});
    public static final BitSet FOLLOW_argument_in_param_definition278 = new BitSet(new long[]{0x0000000000000002L});
    public static final BitSet FOLLOW_ID_in_argument289 = new BitSet(new long[]{0x0000000000000002L,0x0000800000000000L});
    public static final BitSet FOLLOW_dimension_definition_in_argument291 = new BitSet(new long[]{0x0000000000000002L,0x0000800000000000L});
    public static final BitSet FOLLOW_VK_DECLARE_in_type_declaration304 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_VT_TYPE_DECLARE_ID_in_type_declaration306 = new BitSet(new long[]{0x0000000000000000L,0x0000000004090000L});
    public static final BitSet FOLLOW_decl_metadata_in_type_declaration308 = new BitSet(new long[]{0x0000000000000000L,0x0000000004090000L});
    ...
    public static final BitSet FOLLOW_data_type_in_decl_field350 = new BitSet(new long[]{0x0000000000000008L,0x0000000004000000L});
    public static final BitSet FOLLOW_decl_metadata_in_decl_field352 = new BitSet(new long[]{0x0000000000000008L,0x0000000004000000L});
    ...
    public static final BitSet FOLLOW_template_slot_in_template385 = new BitSet(new long[]{0x0000000000008000L,0x0000000000010000L});
    ...
    public static final BitSet FOLLOW_VT_RULE_ID_in_rule420 = new BitSet(new long[]{0x0000000000030000L,0x0000000020000000L});
    public static final BitSet FOLLOW_rule_attributes_in_rule422 = new BitSet(new long[]{0x0000000000020000L,0x0000000020000000L});
    ...
    public static final BitSet FOLLOW_VK_ATTRIBUTES_in_rule_attributes456 = new BitSet(new long[]{0x039FE00000000000L,0x0000000000000000L,0x0000000000000001L});
    public static final BitSet FOLLOW_rule_attribute_in_rule_attributes459 = new BitSet(new long[]{0x039FE00000000008L,0x0000000000000000L,0x0000000000000001L});
    ...
    public static final BitSet FOLLOW_lhs_in_lhs_block611 = new BitSet(new long[]{0x0000000087800008L,0x0000000400000C50L});
    public static final BitSet FOLLOW_VT_OR_PREFIX_in_lhs624 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_lhs_in_lhs626 = new BitSet(new long[]{0x0000000087800008L,0x0000000400000C50L});
    public static final BitSet FOLLOW_VT_OR_INFIX_in_lhs634 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_lhs_in_lhs636 = new BitSet(new long[]{0x0000000087800008L,0x0000000400000C50L});
    ...
    public static final BitSet FOLLOW_lhs_in_lhs647 = new BitSet(new long[]{0x0000000087800008L,0x0000000400000C50L});
    public static final BitSet FOLLOW_VT_AND_INFIX_in_lhs655 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_lhs_in_lhs657 = new BitSet(new long[]{0x0000000087800008L,0x0000000400000C50L});
    ...
    public static final BitSet FOLLOW_lhs_in_lhs695 = new BitSet(new long[]{0x0000000087800008L,0x0000000400000C50L});
    public static final BitSet FOLLOW_FROM_in_lhs703 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_lhs_pattern_in_lhs705 = new BitSet(new long[]{0x0000000020000000L,0x0000003000000020L});
    ...
    public static final BitSet FOLLOW_accumulate_init_reverse_clause_in_accumulate_init_clause805 = new BitSet(new long[]{0x0000000000000000L,0x0000000000004000L});
    ...
    public static final BitSet FOLLOW_ID_in_over_element897 = new BitSet(new long[]{0x0000000000000000L,0x0000000000080000L});
    ...
    public static final BitSet FOLLOW_fact_expression_in_fact_expression916 = new BitSet(new long[]{0x0000001F00100040L,0x00007F83C0488090L});
    ...
    public static final BitSet FOLLOW_fact_expression_in_fact_expression927 = new BitSet(new long[]{0x0000001F00100040L,0x00007F83C0488090L});
    ...
    public static final BitSet FOLLOW_VT_LABEL_in_fact_expression938 = new BitSet(new long[]{0x0000001F00100040L,0x00007F83C0488090L});
    ...
    public static final BitSet FOLLOW_pattern_type_in_fact_expression949 = new BitSet(new long[]{0x0000001F00100048L,0x00007F83C0488090L});
    public static final BitSet FOLLOW_fact_expression_in_fact_expression951 = new BitSet(new long[]{0x0000001F00100048L,0x00007F83C0488090L});
    public static final BitSet FOLLOW_VT_FACT_OR_in_fact_expression959 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_fact_expression_in_fact_expression961 = new BitSet(new long[]{0x0000001F00100040L,0x00007F83C0488090L});
    ...
    public static final BitSet FOLLOW_VK_NOT_in_fact_expression981 = new BitSet(new long[]{0x0000001F00100040L,0x00007F83C0488090L});
    public static final BitSet FOLLOW_fact_expression_in_fact_expression984 = new BitSet(new long[]{0x0000001F00100048L,0x00007F83C0488090L});
    ...
    public static final BitSet FOLLOW_VK_NOT_in_fact_expression1048 = new BitSet(new long[]{0x0000001F00180040L,0x00007F83C0488090L});
    public static final BitSet FOLLOW_VT_SQUARE_CHUNK_in_fact_expression1051 = new BitSet(new long[]{0x0000001F00100040L,0x00007F83C0488090L});
    ...
    public static final BitSet FOLLOW_VK_NOT_in_fact_expression1063 = new BitSet(new long[]{0x0000001F00180040L,0x00007F83C0488090L});
    public static final BitSet FOLLOW_VT_SQUARE_CHUNK_in_fact_expression1066 = new BitSet(new long[]{0x0000001F00100040L,0x00007F83C0488090L});
    ...
    public static final BitSet FOLLOW_VT_LABEL_in_fact_expression1078 = new BitSet(new long[]{0x0000001F00100040L,0x00007F83C0488090L});
    ...
    public static final BitSet FOLLOW_fact_expression_in_fact_expression1089 = new BitSet(new long[]{0x0000001F00100048L,0x00007F83C0488090L});
    ...
    public static final BitSet FOLLOW_ID_in_pattern_type1147 = new BitSet(new long[]{0x0000000000000008L,0x0000800000080000L});
    public static final BitSet FOLLOW_dimension_definition_in_pattern_type1150 = new BitSet(new long[]{0x0000000000000008L,0x0000800000000000L});
    public static final BitSet FOLLOW_VT_DATA_TYPE_in_data_type1164 = new BitSet(new long[]{0x0000000000000004L});
    public static final BitSet FOLLOW_ID_in_data_type1166 = new BitSet(new long[]{0x0000000000000008L,0x0000800000080000L});
    public static final BitSet FOLLOW_dimension_definition_in_data_type1169 = new BitSet(new long[]{0x0000000000000008L,0x0000800000000000L});
    public static final BitSet FOLLOW_LEFT_SQUARE_in_dimension_definition1182 = new BitSet(new long[]{0x0000000000000000L,0x0001000000000000L});
