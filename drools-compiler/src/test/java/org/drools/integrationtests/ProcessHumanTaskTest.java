...
public class ProcessHumanTaskTest extends TestCase {
    ...
    public void testHumanTask() {
        ...
        Reader source = new StringReader(
            ...
            "         type=\"RuleFlow\" name=\"flow\" id=\"org.com.agfa.hap.drools.humantask\" package-name=\"org.com.agfa.hap.drools\" version=\"1\" >\n" +
            "\n" +
            "  <header>\n" +
            "  </header>\n" +
            "\n" +
        ...
        ProcessInstance processInstance = ( ProcessInstance )
            workingMemory.startProcess("org.com.agfa.hap.drools.humantask");
    ...
    public void testHumanTaskCancel2() {
        ...
        Reader source = new StringReader(
            ...
            "      </work>\n" +
            "      <onExit>\n" +
            "        <action type=\"expression\" name=\"Cancel\" dialect=\"java\" >((org.com.agfa.hap.drools.workflow.instance.NodeInstance) kcontext.getNodeInstance()).cancel();</action>\n" +
            "      </onExit>\n" +
            "    </humanTask>\n" +
            "    <end id=\"3\" name=\"End\" />\n" +
            "  </nodes>\n" +
